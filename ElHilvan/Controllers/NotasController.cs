...
namespace WebApplication1.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            var nota = db.Nota.Include(n => n.Clientes).Include(n => n.Empresa).Include(n => n.NotaPrenda);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.idNotaPrenda = new SelectList(db.NotaPrenda, "id", "id");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,FechaEntrega,FechaRecibido,idEmpresa,Folio,idNotaPrenda,idClientes")] Nota nota)
        {
